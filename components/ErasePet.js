...
constructor(props) {
  ...
  await Axios ({
    method:'post',
    url:'https://proyectosita.com/dispenser/erasepet.php',
    data:formData,
  ...
  render() {
    return (
      <View style={styles.MainContainer}>
        <Text style= {{ fontSize: 20, color: "#000", textAlign: 'center', marginBottom: 15 }}>Erase Pet</Text>
        <TextInput
        ...
        />
        <Button title="Erase Pet" onPress={this.handleSubmit} style={styles.Button} />
